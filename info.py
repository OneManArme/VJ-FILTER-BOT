...
PICS = (environ.get('PICS', 'https://telegra.ph/file/424097f63a0e006e8f3b0.jpg')).split()
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001188070894 -1001274359769 -1002341565790 -1001685364040 -100169224324 -1001775437494 -1002223699552 -1002397109795 -1002461730224').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002092476960') # give your force subscribe channel id here else leave it blank
...
O_DB_URI = environ.get('O_DB_URI', "mongodb+srv://mvideo:mvideo@cluster0.bpj54.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # This Db Is For Other Data Store
F_DB_URI = environ.get('F_DB_URI', "mongodb+srv://mvideo:mvideo@cluster0.bpj54.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # This Db Is For File Data Store
S_DB_URI = environ.get('S_DB_URI', "mongodb+srv://video:video@rishi.fzpls33.mongodb.net/?retryWrites=true&w=majority")   # This Db is for File Data Store When First Db Is Going To Be Full.
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/JAsuran2p0')
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', 'ee6ed3feea08d70e8bfaf2fe30a8c72bae5baa32')
